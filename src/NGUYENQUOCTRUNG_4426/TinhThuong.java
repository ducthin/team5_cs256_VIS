 ...
 * @author trung
 */
public class TinhThuong extends javax.swing.JFrame {

    /**
     * Creates new form TinhThuong
     */
    public TinhThuong() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Exit2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        Exit2.setText("X");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(Exit2, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void EnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnterActionPerformed
        ...
        //Thuc hien phep tru
        try{
            double a = Integer.parseInt(S1.getText());
            double b = Integer.parseInt(S2.getText());
            double x = a/b;
            Result.setForeground(Color.BLUE);
            Result.setText("Result : " + a +" / " + b +" = "+ x);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TinhThuong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TinhThuong().setVisible(true);
            }
        });
    }
