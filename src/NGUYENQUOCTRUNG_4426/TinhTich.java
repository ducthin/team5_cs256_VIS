 ...
 * @author trung
 */
public class TinhTich extends javax.swing.JFrame {

    /**
     * Creates new form TinhTich
     */
    public TinhTich() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TinhTich.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
